 ...
 * USAGE:
 * <pre>
 *        MeteoVrijemeKlijent client = new MeteoVrijemeKlijent();
 ...
 * @author NWTiS_1
 */
public class MeteoVrijemeKlijent {
    ...
    public MeteoVrijemeKlijent(String icao, String vrijeme) {
     ...
     */
    public <T> T dajAerodromVrijemeLong(Class<T> responseType, String korisnik, String lozinka) throws jakarta.ws.rs.ClientErrorException {
