...
public class AerodromiKlijent {
    ...
    public AerodromiKlijent(String icao, String dan) {
     ...
     */
    public <T> T dajAerodromLetoviDan(Class<T> responseType, String korisnik, String lozinka) throws jakarta.ws.rs.ClientErrorException {
