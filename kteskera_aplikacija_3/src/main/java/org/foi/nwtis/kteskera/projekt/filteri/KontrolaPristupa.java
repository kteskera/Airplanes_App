 ...
 */
package org.foi.nwtis.kteskera.projekt.filteri;
 ...
 * @author NWTiS_1
 */
@WebFilter(filterName = "KontrolaPristupa", urlPatterns = {"/mvc/aerodromi","/mvc/podrucja","/mvc/komanda"})
public class KontrolaPristupa implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (sesija == null || sesija.getAttribute("korisnik") == null) {
            RequestDispatcher rd = request.getRequestDispatcher("/mvc/korisnik/prijava");
