...
public class KorisnikPodaciSocket {
    ...
    public String grant(String username, String id, String podrucje) {
        String komanda = "GRANT " + username + " " + id + " " + podrucje;
        return izvrsiKomandu(komanda, posluzitelj, port);
    }

    public String revoke(String username, String id, String podrucje) {
        String komanda = "REVOKE " + username + " " + id + " " + podrucje;
        return izvrsiKomandu(komanda, posluzitelj, port);
    }

    public String rights(String username, String id) {
        String komanda = "RIGHTS " + username + " " + id;
        return izvrsiKomandu(komanda, posluzitelj, port);
    }
